		...
		try {
			if(context==null){
				if(mediaType.equals(MimeMediaType.JSON)){
					...
					InputStream iStreamJsonBinding = classLoader.getResourceAsStream("binding/json-binding.json");
					InputStream iStreamJsonBindingFlexcontainer = classLoader.getResourceAsStream("binding/json-binding-flexcontainer.json");
					...
					// XML
					ClassLoader classLoader = Mapper.class.getClassLoader(); 
					InputStream iStream = classLoader.getResourceAsStream("binding/xml-binding.xml"); 
					Map<String, Object> properties = new HashMap<String, Object>(); 
